...
class ANN() : # to take preprocessed data , pass them into model and print results
    ...
    def fit(self,x_train  , y_train  , x_test, y_test , outputdim) :         
      #Fitting ANN Model
        ...
        model.add(Dense(60, activation='tanh',kernel_regularizer='l2',input_shape = (input_dim,)))
        model.add(Dense(30, activation='tanh',kernel_regularizer='l2'))
...
for met in measures:
    ...
    print("###############")
    fname='table_'+dataset+'_ANN_'+met+'_5RE.txt'
    tables = open(fname, 'w')
